        ...
        <div class="formulaire-dashboard-container">
            ...
            <div class="form-group" id="drop-zone">
                ...
                <div id="image-temoignage-preview-container">
                    @if ($temoignage->image_temoignage)
                        <img id="image-temoignage-preview" src="{{ asset('BackOffice/public/storage/image_temoignage/' . $temoignage->image_temoignage) }}" alt="Preview" style="max-width: 100%; max-height: 200px;">
                    @else
            ...
            <div class="form-group">
                ...
                <textarea class="input-box text text-area-dashboard" name="contenu_temoignage" id="contenu_temoignage" maxlength="3000">{{ $temoignage->contenu_temoignage }}</textarea>
