...
<form action="{{ route('actions.update', [$action['id']]) }}" method="post" enctype="multipart/form-data" class="formulaire-dashboard">
    ...
    <div class="header-form-container">
        <h3 class="mgb-15">Modifier une Action</h3>
    ...
    <div class="form-group">
        ...
        <input type="text" class="input-box text" name="titre_action" id="titre_action"  value="{{$action->titre_action}}" class="form-control"/>
    ...
    <div class="form-group">
        ...
        <input type="date" class="input-box text" name="date_action" id="date_action" value="{{$action->date_action}}" class="form-control"/>
    ...
    <div class="form-group">
        ...
        <input type="time" class="input-box text" name="heure_action" id="heure_action" value="{{$action->heure_action}}" class="form-control"/>
    ...
    <div class="form-group">
        ...
        <input type="text" class="input-box text" name="adresse_action" id="adresse_action" value="{{$action->adresse}}" class="form-control"/>
    ...
    <div class="form-group">
        ...
        <input type="text" class="input-box text" name="code_postal_action" id="code_postal_action" value="{{$action->code_postal}}" class="form-control"/>
    ...
    <div class="form-group">
        ...
        <input type="text" class="input-box text" name="ville_action" id="ville_action" value="{{$action->ville}}" class="form-control"/>
    ...
    <div class="form-group">
        ...
        <input type="text" class="input-box text" name="nb_inscrits_action" id="nb_inscrits_action" value="{{$action->nb_inscrits}}" class="form-control"/>
    ...
    <div class="form-group">
        ...
        <input type="text" class="input-box text" name="nb_sensibilises_action" id="nb_sensibilises_action" value="{{$action->nb_sensibilises}}" class="form-control"/>
